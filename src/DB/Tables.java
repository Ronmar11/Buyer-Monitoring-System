       ...
       public static void main(String[] args) {
           try {
               ...
               String transactionTable = "CREATE TABLE transaction ("
                      ...
                      + "quantity INT, "
                      + "date DATE, "
                      + "INDEX client_idx (client_name), " // Corrected INDEX syntax
                      + "INDEX product_idx (product_name), " // Corrected INDEX syntax
                      + "FOREIGN KEY (client_name) REFERENCES client(client_name) ON UPDATE CASCADE ON DELETE CASCADE, " // Fixed foreign key column name
                      + "FOREIGN KEY (product_name) REFERENCES Product(product_name) ON UPDATE CASCADE ON DELETE CASCADE"
                      + ")";
